...
int main(int argc, const char * argv[]){
    ...
    data = list_data(element);
    fprintf(stdout,"Removing an element after the on containing %03d\n",*data);
    ...
    *data = 12;
    ...
    fprintf(stdout,"Interating and removing the fourth element\n");
    ...
    fprintf(stdout,"Inserting 013 after the first of the element\n");
    ...
    *data = 13;
    ...
    fprintf(stdout, "testing list is_head ... vlaue=%d (1=OK)\n",i);
    i = list_is_head(&list,list_tail(&list));
    fprintf(stdout, "testing list is_head ... vlaue=%d (1=OK)\n",i);

    i = list_is_tail(&list,list_tail(&list));
    fprintf(stdout, "testing list is_tail ... vlaue=%d (1=OK)\n",i);
